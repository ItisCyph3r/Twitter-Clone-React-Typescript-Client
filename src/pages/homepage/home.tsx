...
import './home.css';
import SimpleAccordion from '../../conponents/simple-accordion/simple_accordion';
        ...
        <>
            {
                userObject ?
                    <div className=' w-full flex overflow-hidden bg-black m-auto h-screen lg:w-[93%] relative'>
                        ...
                        {
                            sideNav &&
                            <div className= 'w-[100%] absolute top-0 flex z-[999] h-screen overflow-hidden'>
                                <div className='w-[65%] bg-black h-full overflow-y-scroll'>
                                    <div className='px-3'>
                                        <div className='py-4 flex justify-between font-extrabold text-sm'>
                                            <div>
                                                Account Info
                                            </div>
                                        ...
                                        <div className='text-[0.95rem] mt-2'>
                                    ...
                                    <SimpleAccordion username={userState.userName}/>
                                </div>
